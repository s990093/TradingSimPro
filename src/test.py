...
# Local imports
from mult_strategy.utility.print import display_results
from mult_strategy.utility.helper.tool import trades_to_dataframe
from mult_strategy.utility.stock_plotter import plot_trades
...
from mult_strategy.strategies.ENV import Environment
from config import StrategyConfig

# Download stock data for target stock and benchmark (e.g., S&P 500)
df_data = StockDataCache(StrategyConfig.target_stock, StrategyConfig.start_date, StrategyConfig.end_date).get_data()

benchmark_df = StockDataCache('^GSPC', Environment.start_date, StrategyConfig.end_date).get_data()
