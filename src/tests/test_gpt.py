from src.utils.stock_data_cache import StockDataCache
import openai
import pandas as pd
import random
...
client = OpenAI(
    api_key="sk-7CMAFHKhJ5i7GzEYZfEwbvVeb5mBDsZmHJsiTatf6hvPSuYh",  # 請確保您使用的是安全存取的 API 金鑰
    base_url="https://api.chatanywhere.tech/v1"  # 請選擇合適的 base_url
)
